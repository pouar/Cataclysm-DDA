...
void game::do_blast( const tripoint &p, const float power,
                     const float distance_factor, const bool fire, float damagemultiplier )
{
...
void game::explosion( const tripoint &p, float power, float factor,
                      int shrapnel_count, bool fire, float damagemultiplier )
{
    ...
    if( factor >= 1.0f ) {
        ...
        do_blast( p, power, factor, fire, damagemultiplier );
    }
