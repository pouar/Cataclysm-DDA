...
The latest instructions on how to compile can be found in [COMPILING.md](https://github.com/pouar/Cataclysm-DDA/blob/master/COMPILING.md), cmake instructions in [COMPILING-CMAKE.md](https://github.com/pouar/Cataclysm-DDA/blob/master/COMPILING-CMAKE.md).  See [doc/COMPILER_SUPPORT.md] (https://github.com/pouar/Cataclysm-DDA/blob/master/doc/COMPILER_SUPPORT.md) for details on which compilers CDDA supports. And you can always dig for more information in `doc/`
